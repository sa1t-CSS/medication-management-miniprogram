...
Page({
  ...
  loadMedicationData: function() {
    ...
    const dateMedicationData = Array.isArray(datePlans.noon) ? datePlans.noon : [];
    const medicationData = dateMedicationData.length > 0 ? dateMedicationData : app.getMedicationData('noon');
